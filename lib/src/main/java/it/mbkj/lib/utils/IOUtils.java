...
public class IOUtils {
  ...
  /*  public static boolean contentEquals(InputStream input1, InputStream input2) throws IOException {
        InputStream input1 = toBufferedInputStream(input1);
        InputStream input2 = toBufferedInputStream(input2);
    ...
    public static long getDirSize(String path) {
        ...
        return Build.VERSION.SDK_INT >= 18 ? getStatFsSize(stat, "getBlockSizeLong", "getAvailableBlocksLong") : getStatFsSize(stat, "getBlockSize", "getAvailableBlocks");
    }
